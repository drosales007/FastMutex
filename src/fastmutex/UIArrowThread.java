...
public class UIArrowThread extends SwingWorker<Integer, String>{
    ...
    private Point[] getPoints(){
        ...
        Point s = new Point(FastMutex.srvLabels.get(source).centerX,
                            FastMutex.srvLabels.get(source).centerY);
        Point t = new Point(FastMutex.srvLabels.get(target).centerX,
                            FastMutex.srvLabels.get(target).centerY);
